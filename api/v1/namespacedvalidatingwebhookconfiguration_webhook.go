...
var namespacedvalidatingwebhookconfigurationlog = logf.Log.WithName("namespacedvalidatingwebhookconfiguration-resource")

func (r *NamespacedValidatingWebhookConfiguration) SetupWebhookWithManager(mgr ctrl.Manager) error {
...
var _ webhook.Defaulter = &NamespacedValidatingWebhookConfiguration{}

// Default implements webhook.Defaulter so a webhook will be registered for the type
func (r *NamespacedValidatingWebhookConfiguration) Default() {
	namespacedvalidatingwebhookconfigurationlog.Info("default", "name", r.Name)
