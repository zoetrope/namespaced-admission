...
var _ = Describe("NamespacedMutatingWebhookConfiguration controller", func() {
	...
	BeforeEach(func() {
		...
		nr := &NamespacedMutatingWebhookConfigurationReconciler{
	...
	It("should create and delete MutatingWebhookConfiguration", func() {
		ns := &corev1.Namespace{}
		ns.Name = "test1"
		...
		nmw := &webhookv1.NamespacedMutatingWebhookConfiguration{}
